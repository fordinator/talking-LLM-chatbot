...
###################################################################################################################################################
# ESSENTIAL VARIABLES: These MUST be set because I ain't paying for your shit. ElevenLabs is currently the best AI voice model right now,         #
# Mistral is a bit behind OpenAI but using it is DIRT CHEAP. So, you need to subscribe to both MistralAI and ElevenLabs and provide your own API  #
# keys here.                                                                                                                                      #
###################################################################################################################################################
